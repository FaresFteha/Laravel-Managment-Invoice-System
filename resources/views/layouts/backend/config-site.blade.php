            ...
            <div class="row gx-2">
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset('asset/backend/src/img/generic/falcon-mode-default.jpg') }}"
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset('asset/backend/src/img/generic/falcon-mode-dark.jpg') }}"
...
<script src="{{ asset('asset/backend/src/vendors/bootstrap/bootstrap.min.js') }}"></script>
