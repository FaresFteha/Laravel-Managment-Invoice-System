                        ...
                        <div class="card-body p-0 pb-3">
                            <div class="d-flex align-items-center justify-content-end my-3">
                                <div id="bulk-select-replace-element">
                                    @can('جميع الحالات')
                                        <a href="{{ route('invoicesstatus.create') }}">
                            ...
                            <div class="table-responsive scrollbar">
                                @include('page.backend.Invoices.Invoicestatus.Filters.filtre')
                                    ...
                                    <tbody id="bulk-select-body">
                                        @forelse ($Incoices as $items)
                                            <tr>
                                                ...
                                                <th>
                                                    @can('الحالات')
                                                        <a href="{{ route('invoicesstatus.show', $items->id) }}">
                                                            <button class="btn btn-sm btn-primary d-lg-block mt-lg-2"
                                                                type="button"> الحالات</button>
                                                        </a>
                                                    @endcan
