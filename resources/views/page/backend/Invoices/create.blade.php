                    ...
                    <form action="{{ route('invoices.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select js-choice" id="client_id" name="client_id"
                                value="{{ old('client_id') }}">
                                <option selected disabled>حدد العميل...</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" id="invoice_number" name="invoice_number" type="text"
                                value="{{ old('invoice_number', randomDigit()) }}" readonly />
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control datetimepicker" id="datepicker" type="text" placeholder="d/m/y"
                                data-options='{"disableMobile":true}' name="due_date" value="{{ old('due_date') }}" />
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select js-choice" id="tax_id" name="tax_id"
                                value="{{ old('tax_id') }}" onchange="myFunction()">
                        ...
                        <div class="card-header bg-light">
                            <div class="row flex-between-center">
                                <div class="col-sm-auto">
                                    <h5 class="mb-2 mb-sm-0">ملفات الفاتورة</h5>
                                </div>
                            </div>
                        </div>
                        <br>
                        {{-- Invoice photo --}}
                        <div class="row">
                            <label class="col-form-label" for="photo">مرفق الفاتورة: <small style="color: red">أنواع
                                    الملفات المسموح بها: png, jpg, jpeg, pdf.</small></label>

                            <div class="col-sm-10">
                                <input class="form-control" id="photo" name="photo" type="file" data-fouc />
                            </div>
                        </div>
                        <div
                            class="col-md-5 col-xl-12 col-xxl-5 ps-lg-4 ps-xl-2 ps-xxl-5 text-center text-md-start text-xl-center text-xxl-start">
                            <button class="btn btn-success mt-3 px-5" type="submit">تاكيد &amp; شراء</button>
                        </div>
                    </form>
                </div>
            </div>
