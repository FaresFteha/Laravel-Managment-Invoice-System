                                ...
                                <table class="table mb-0">
                                    <thead class="text-black bg-200">
                                        <tr>
                                            ...
                                            <th class="align-middle">الاسم / الايميل</th>
                                            <th class="align-middle white-space-nowrap pe-3">العمليات</th>
                                        </tr>
                                    </thead>
                                    <tbody id="bulk-select-body">
                                        @forelse ($Clients as $items)
                                            <tr>
                                                ...
                                                <th class="align-middle">{{ $items->email }}<br>
                                                    <a
                                                        href="{{ route('clients.show', $items->id) }}"><strong>{{ $items->full_name }}</strong></a>

                                                </th>
                                                <td class="align-middle">
                                                    <div>
                                                        @can('تعديل العملاء')
                                                            <a href="{{ route('clients.edit', $items->id) }}">
                                            ...
                                            {{-- Delete Modal --}}
                                            @include('page.backend.Clients.modal-include.delete')
                                        @empty
                                            <tr>
