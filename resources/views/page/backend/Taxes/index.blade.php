                    ...
                    <div class="card shadow-none">
                        <div class="card-body p-0 pb-3">
                            ...
                            <div class="table-responsive scrollbar">
                                @include('page.backend.Taxes.Filters.filtre')
                                <table class="table mb-0">
                                    ...
                                    <tbody id="bulk-select-body">
                                        @forelse ($tax as $items)
                                            ...
                                            {{-- Intro Edit Modal --}}
                                            @include('page.backend.Taxes.modal-include.edit')
                                            @include('page.backend.Taxes.modal-include.delete')
                                        @empty
                                            <tr>
                                ...
                                {{-- Insert New Modal --}}
                                @include('page.backend.Taxes.modal-include.add')
